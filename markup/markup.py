...
class Keyboards:
    ...
    def category_menu(self):
        ...
        self.markup.add(self.set_btn('CLASIC_LITERATURE'))
        self.markup.add(self.set_btn('FICTION'))
        self.markup.add(self.set_btn('FANTASY'))
        self.markup.add(self.set_btn('ROMANTIC_PROSE'))
        self.markup.add(self.set_btn('Thriller'))
        self.markup.add(self.set_btn('Mystery'))
